...
- (void).cxx_destruct;	// IMP=0x0020000000259e3a
...
- (void)main;	// IMP=0x0010000000258b1f
- (id)initWithLocalRevision:(id)arg1 reason:(long long)arg2 client:(id)arg3;	// IMP=0x0010000000258a26
