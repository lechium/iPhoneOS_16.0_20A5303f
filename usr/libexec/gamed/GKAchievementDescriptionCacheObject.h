...
+ (id)entityName;	// IMP=0x0020000000057646
- (id)internalRepresentation;	// IMP=0x0020000000057301
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000056f1a
