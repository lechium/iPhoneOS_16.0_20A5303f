...
@class FriendsPlayedGameList, GKGameDescriptor, GKLeaderboardInternal, GKLeaderboardScoreRequest, GKPlayerInternal, MISSING_TYPE, NSArray, NSManagedObjectContext, NSSet, NSString;
...
- (MISSING_TYPE *)expireGamesFriendsPlayed;
