...
@class APSConnection, APSIncomingMessage, APSOutgoingMessage, APSURLToken, APSURLTokenInfo, MISSING_TYPE, NSArray, NSData, NSDictionary, NSError, NSString;
...
- (MISSING_TYPE *)connection:didReceiveToken:forInfo: /* Error: Ran out of types for this method. */;
