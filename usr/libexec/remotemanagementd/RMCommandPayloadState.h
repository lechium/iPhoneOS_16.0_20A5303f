...
- (void)markPending;	// IMP=0x0020000000021edc
- (void)markFailedWithError:(id)arg1 reasons:(id)arg2;	// IMP=0x0010000000021b8c
- (void)markExecutedWithResult:(id)arg1 reasons:(id)arg2 unknownPayloadKeys:(id)arg3;	// IMP=0x0010000000021819
- (void)markQueued;	// IMP=0x00100000000217b6
