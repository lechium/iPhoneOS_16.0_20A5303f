...
- (id)reportDetails;	// IMP=0x001000000000891c
@property(retain, nonatomic) RMPredicateDescription *predicateDescription;
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x001000000000953b
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000008bfc
