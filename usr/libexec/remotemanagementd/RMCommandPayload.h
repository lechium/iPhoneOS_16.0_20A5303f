...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x0020000000020e33
- (id)reportDetails;	// IMP=0x0020000000021680
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x0010000000021116
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x0010000000020ea3
