...
- (id)reportDetails;	// IMP=0x0010000000009c50
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x0010000000009fcd
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000009d29
