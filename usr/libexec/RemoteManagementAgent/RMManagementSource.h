...
+ (id)fetchRequestWithAccountIdentifier:(id)arg1;	// IMP=0x002000000004ff4e
+ (id)fetchRequestWithIdentifier:(id)arg1;	// IMP=0x001000000004fea7
+ (id)fetchRequestWithDeviceChannel;	// IMP=0x001000000004fe24
+ (id)fetchRequestWithBootstrapURI:(id)arg1 enrollmentType:(short)arg2;	// IMP=0x001000000004fd6f
+ (id)fetchRequestWithBootstrapURI:(id)arg1;	// IMP=0x001000000004fcc8
- (id)reportDetails;	// IMP=0x002000000004fff5
- (void)awakeFromInsert;	// IMP=0x001000000004fc33
