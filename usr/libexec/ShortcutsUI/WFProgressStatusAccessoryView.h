...
- (void).cxx_destruct;	// IMP=0x00200000000032e3
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000003070
- (void)stopRunning;	// IMP=0x0010000000002ef3
- (void)layoutSubviews;	// IMP=0x0010000000002e5d
- (id)initWithRunningContext:(id)arg1;	// IMP=0x0010000000002b47
