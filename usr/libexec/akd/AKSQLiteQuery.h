...
+ (id)queryWithString:(id)arg1;	// IMP=0x004000000009260e
- (void).cxx_destruct;	// IMP=0x0020000000092c29
...
- (_Bool)_bindStatement:(struct sqlite3_stmt *)arg1 withParameter:(id)arg2 atPosition:(int)arg3;	// IMP=0x0010000000092ad7
- (void)bindParameters:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000092855
- (void)bindParameter:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000092664
