...
@class MISSING_TYPE, NSDateInterval, NSDictionary, NSNumber, NSSecurityScopedURLWrapper, NSString, NSURL, STIntroductionModel;

@protocol STManagementStateServerInterface <NSObject>
- (MISSING_TYPE *)setLocationSharingModificationAllowed:forDSID:completionHandler: /* Error: Ran out of types for this method. */;
