...
- (void).cxx_destruct;	// IMP=0x002000000001e6f8
...
- (id)compile;	// IMP=0x001000000001e012
- (id)initWithCloudPushDictionary:(id)arg1 bag:(id)arg2;	// IMP=0x001000000001c81a
- (id)initWithCloudPushDictionary:(id)arg1;	// IMP=0x001000000001c799
- (id)initWithApproverDSID:(id)arg1 date:(id)arg2 identifier:(id)arg3 itemBundleID:(id)arg4 itemDescription:(id)arg5 itemIdentifier:(id)arg6 itemTitle:(id)arg7 localizations:(id)arg8 offerName:(id)arg9 mocked:(_Bool)arg10 previewURL:(id)arg11 productType:(id)arg12 productTypeName:(id)arg13 productURL:(id)arg14 requesterName:(id)arg15 requesterDSID:(id)arg16 requestInfo:(id)arg17 status:(long long)arg18;	// IMP=0x001000000001c4ee
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001be94
