...
+ (id)fromProto:(id)arg1;	// IMP=0x0040000000003833
+ (id)toProto:(id)arg1;	// IMP=0x001000000000361c
- (void).cxx_destruct;	// IMP=0x0020000000003af1
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000003308
- (id)init;	// IMP=0x00100000000032d9
