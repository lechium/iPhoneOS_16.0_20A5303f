...
@class MISSING_TYPE, NSDictionary, NSError, NSNumber, NSString, RPRemoteDisplayDevice;
...
- (MISSING_TYPE *)remoteDisplayShowPassword:flags: /* Error: Ran out of types for this method. */;
@end
