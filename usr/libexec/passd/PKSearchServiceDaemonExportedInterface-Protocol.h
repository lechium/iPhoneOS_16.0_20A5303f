...
- (void)updateRegionWithIdentifier:(NSString *)arg1 localizedName:(NSString *)arg2 boundingRegion:(CDStruct_26e8d939)arg3 mapsIdentifier:(unsigned long long)arg4 providerIdentifier:(int)arg5 completion:(void (^)(PKWorldRegion *))arg6;
