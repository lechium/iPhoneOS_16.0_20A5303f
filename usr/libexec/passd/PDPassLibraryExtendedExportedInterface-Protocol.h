...
@class CLLocation, MISSING_TYPE, NSArray, NSData, NSMapTable, NSNumber, NSSet, NSString, PKAddShareablePassConfiguration, PKAppleAccountChange, PKContact, PKDisplayProfile, PKDisplayTraitCollection, PKFieldProperties, PKFileDescriptorXPCContainer, PKGroupsControllerSnapshotFetchOptions, PKPassesXPCContainer, PKPaymentSetupRequest;
...
- (MISSING_TYPE *)usingSynchronousProxy:getImageSetContainerForUniqueID:type:withDisplayProfile:suffix:handler: /* Error: Ran out of types for this method. */;
