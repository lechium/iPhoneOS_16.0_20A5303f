...
@class GSDocumentIdentifier, MISSING_TYPE, NSArray, NSData, NSDictionary, NSFileHandle, NSString, NSURL, NSUUID;
...
- (MISSING_TYPE *)checkItemAtURLValidInsidePermanentStorage:reply: /* Error: Ran out of types for this method. */;
