...
@class IXAppInstallCoordinatorSeed, IXApplicationIdentity, IXPlaceholderAttributes, IXPlaceholderSeed, IXPromisedAppReferenceSeed, IXPromisedInMemoryDataSeed, IXPromisedOutOfBandStreamingZipTransferSeed, IXPromisedOutOfBandTransferSeed, IXPromisedStreamingZipTransferSeed, IXPromisedTransferToPathSeed, IXUninstallOptions, NSArray, NSData, NSDictionary, NSError, NSPredicate, NSSet, NSString, NSURL, NSUUID, NSXPCListenerEndpoint;
