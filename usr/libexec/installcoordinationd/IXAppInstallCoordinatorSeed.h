...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000058f07
- (void).cxx_destruct;	// IMP=0x00200000000595ee
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000059442
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000059267
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000058f0f
