...
@class AVVCAlertInformation, AVVCAudioBuffer, AVVoiceController, MISSING_TYPE, NSArray, NSDictionary, NSError;
...
- (MISSING_TYPE *)voiceControllerDidStopRecording:forStream:forReason: /* Error: Ran out of types for this method. */;
