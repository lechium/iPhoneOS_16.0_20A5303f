...
- (void).cxx_destruct;	// IMP=0x00200000000db665
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000db501
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5;	// IMP=0x00100000000daeb4
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x00100000000daeae
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x00100000000daea8
- (void)stopAudioStream;	// IMP=0x00100000000dad88
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000dabfe
- (_Bool)isRecording;	// IMP=0x00100000000dab4a
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000dab1b
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00100000000daaec
- (void)stop;	// IMP=0x00100000000daa27
- (void)start;	// IMP=0x00100000000da94f
- (void)dealloc;	// IMP=0x00100000000da895
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000da7a3
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00100000000da6ef
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00100000000da683
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00100000000da67b
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000000da513
