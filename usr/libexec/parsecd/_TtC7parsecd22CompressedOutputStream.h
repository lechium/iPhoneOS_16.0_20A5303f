...
- (void).cxx_destruct;	// IMP=0x0040000000019958
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x00100000000198f5
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x00100000000198ca
- (id)initToMemory;	// IMP=0x001000000001989f
- (void)close;	// IMP=0x0010000000019858
- (void)open;	// IMP=0x0010000000019529
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x00100000000193b4
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x0010000000018eea
- (id)init;	// IMP=0x0010000000018c70
