...
+ (id)sharedCryptographer;	// IMP=0x004000000000671d
- (void).cxx_destruct;	// IMP=0x0020000000006f1e
...
- (id)stringDigestForName:(id)arg1;	// IMP=0x0010000000006b20
@property(readonly, nonatomic) NSData *deviceSalt;
- (void)prewarmDeviceSalt;	// IMP=0x00100000000067ca
- (id)init;	// IMP=0x0010000000006772
