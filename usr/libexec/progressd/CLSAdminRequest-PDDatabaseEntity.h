...
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x00200000000b7230
+ (id)entityName;	// IMP=0x00100000000b6d74
- (void)bindTo:(id)arg1;	// IMP=0x00200000000b6fc9
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x00100000000b6d81
