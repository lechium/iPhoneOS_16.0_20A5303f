...
- (void).cxx_destruct;	// IMP=0x00200000000141f2
...
- (void)acknowledgeiCloudIdentity;	// IMP=0x0010000000013dc3
- (_Bool)didUnacknowledgediCloudLogoutOccur;	// IMP=0x0010000000013a83
- (void)forceUpdateTokenWithString:(id)arg1;	// IMP=0x0010000000013a00
- (void)fetchCurrentToken;	// IMP=0x001000000001398f
- (id)initWithContainerURL:(id)arg1 trackingLiverpool:(_Bool)arg2;	// IMP=0x001000000001382e
