...
+ (id)configuration;	// IMP=0x0020000000014df1
- (void).cxx_destruct;	// IMP=0x00200000000150e8
...
- (_Bool)shouldPerformDatabaseSubscriptionForServiceMode:(_Bool)arg1;	// IMP=0x0010000000014fd9
- (_Bool)shouldArchiveData:(id)arg1;	// IMP=0x0010000000014fd1
