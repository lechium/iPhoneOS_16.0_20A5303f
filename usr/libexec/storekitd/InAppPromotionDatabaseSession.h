...
- (void).cxx_destruct;	// IMP=0x00200000000039e4
@property(readonly) SQLiteConnection *connection; // @synthesize connection=_connection;
- (id)promotionInfoForProductIdentifiers:(id)arg1 bundleID:(id)arg2 error:(id *)arg3;	// IMP=0x00100000000034ef
- (id)initWithConnection:(id)arg1;	// IMP=0x0010000000003484
