...
+ (id)_familyMembersFromDictionaryRepresentation:(id)arg1;	// IMP=0x004000000009bbbf
- (void).cxx_destruct;	// IMP=0x002000000009c3ad
...
- (id)description;	// IMP=0x001000000009bb3d
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1 cached:(_Bool)arg2;	// IMP=0x001000000009b863
