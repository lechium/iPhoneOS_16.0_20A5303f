...
- (void).cxx_destruct;	// IMP=0x00200000000732cf
@property(readonly, nonatomic) DMDPolicyPersistence *policyPersistence; // @synthesize policyPersistence=_policyPersistence;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000073165
- (id)initWithPolicyPersistence:(id)arg1;	// IMP=0x00100000000730fa
