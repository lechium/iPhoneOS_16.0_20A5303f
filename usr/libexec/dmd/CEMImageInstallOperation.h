...
- (void).cxx_destruct;	// IMP=0x00200000000066ef
...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x001000000000665b
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x0010000000006355
...
- (void)main;	// IMP=0x0010000000006190
- (_Bool)isAsynchronous;	// IMP=0x0010000000006188
- (id)initWithImageDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x00100000000060e6
