...
- (void).cxx_destruct;	// IMP=0x0020000000080e30
@property(readonly, nonatomic) CATTaskServer *taskServer; // @synthesize taskServer=_taskServer;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000080d2c
- (id)initWithTaskServer:(id)arg1;	// IMP=0x0010000000080cc1
