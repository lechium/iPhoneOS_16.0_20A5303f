...
- (void)main;	// IMP=0x00100000000d07af
- (int)mainInternal;	// IMP=0x00100000000d07a4
- (_Bool)isCancelled;	// IMP=0x00100000000d0754
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000d06a0
- (id)init;	// IMP=0x00100000000d0692
