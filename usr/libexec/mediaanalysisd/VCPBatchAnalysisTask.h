...
+ (id)taskWithPhotoLibrary:(id)arg1;	// IMP=0x004000000005c715
- (void).cxx_destruct;	// IMP=0x002000000005d60c
...
- (int)mainInternal;	// IMP=0x001000000005ce11
- (_Bool)containsAsset:(id)arg1;	// IMP=0x001000000005cb96
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3;	// IMP=0x001000000005caf9
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3 allowStreaming:(_Bool)arg4;	// IMP=0x001000000005c77a
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x001000000005c646
