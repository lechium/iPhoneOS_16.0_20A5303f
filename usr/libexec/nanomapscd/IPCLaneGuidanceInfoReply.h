...
+ (id)ipcReplyForLaneGuidanceInfo:(id)arg1;	// IMP=0x002000000003f299
- (void).cxx_destruct;	// IMP=0x0010000000015585
...
- (id)description;	// IMP=0x001000000001539e
- (id)dictionaryValue;	// IMP=0x0010000000015112
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000014e9f
- (id)laneGuidanceInfo;	// IMP=0x001000000003f3c4
