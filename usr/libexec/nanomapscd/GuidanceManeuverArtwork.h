...
+ (id)artworkWithManeuver:(int)arg1;	// IMP=0x0040000000015f6c
- (void).cxx_destruct;	// IMP=0x002000000001626b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000160fc
- (unsigned long long)hash;	// IMP=0x0010000000016094
@property(readonly, nonatomic) _Bool isArriveManeuver;
@property(readonly, nonatomic) _Bool isStartRouteManeuver;
- (id)initWithManeuver:(int)arg1 junction:(id)arg2 drivingSide:(int)arg3 artworkDataSource:(id)arg4;	// IMP=0x0010000000015fa1
- (_Bool)isValue:(id)arg1 equalTo:(id)arg2;	// IMP=0x0010000000015ed4
