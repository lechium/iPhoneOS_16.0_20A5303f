...
+ (id)defaultRouteAttributesForNavigationOfType:(int)arg1;	// IMP=0x004000000001f651
- (void).cxx_destruct;	// IMP=0x0020000000020ac1
...
- (void)_handleDirectionsResponse:(id)arg1 forRequest:(id)arg2 waypoints:(id)arg3 error:(id)arg4 directionsError:(id)arg5;	// IMP=0x00100000000203c8
- (void)cancel;	// IMP=0x0010000000020351
- (void)loadNewRouteSet;	// IMP=0x001000000002000e
- (void)_addTimepointIfNeededToRouteAttributes:(id)arg1;	// IMP=0x001000000001fea8
- (id)_directionsRequestParameters;	// IMP=0x001000000001f83e
- (void)_setupFeedbackIfNeeded;	// IMP=0x001000000001f746
- (id)initWithWaypoints:(id)arg1 type:(int)arg2 currentLocation:(id)arg3 fromCurrentLocation:(_Bool)arg4 withFeedback:(id)arg5;	// IMP=0x001000000001f586
- (id)init;	// IMP=0x001000000001f547
- (void)dealloc;	// IMP=0x001000000001f4f4
