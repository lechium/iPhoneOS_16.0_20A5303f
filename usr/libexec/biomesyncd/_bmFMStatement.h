...
- (void).cxx_destruct;	// IMP=0x0020000000042e14
...
- (id)description;	// IMP=0x0010000000042d2b
- (void)reset;	// IMP=0x0010000000042d09
- (void)close;	// IMP=0x0010000000042cdf
- (void)dealloc;	// IMP=0x0010000000042ca1
