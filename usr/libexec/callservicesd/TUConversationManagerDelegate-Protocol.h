...
@class MISSING_TYPE, NSArray, NSData, NSError, NSSet, NSString, TUConversation, TUConversationActivityEvent, TUConversationActivitySession, TUConversationLink, TUConversationManager, TUConversationMember, TUConversationNotice, TUConversationParticipant;
...
- (MISSING_TYPE *)conversationManager:linkChangedForConversation: /* Error: Ran out of types for this method. */;
