...
+ (id)sharedMetricsWithPhotoLibrary:(id)arg1;	// IMP=0x0040000000057f6b
- (void).cxx_destruct;	// IMP=0x0020000000058ba3
- (int)persist;	// IMP=0x0010000000058441
- (int)reportAnalyzedAsset:(id)arg1 withAnalysis:(id)arg2 andProcessingTime:(double)arg3;	// IMP=0x001000000005818d
- (void)dealloc;	// IMP=0x0010000000057edf
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0010000000057480
