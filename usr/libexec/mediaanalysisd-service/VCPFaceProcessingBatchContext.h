...
+ (id)batchContextWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x004000000006e75b
- (void).cxx_destruct;	// IMP=0x002000000006ef7e
...
- (_Bool)downloadTimedout;	// IMP=0x001000000006ed13
- (void)updateLastestDownloadTimestamp;	// IMP=0x001000000006ebef
- (void)storeResource:(id)arg1 resourceURL:(id)arg2 isBestResource:(_Bool)arg3 requestDownload:(_Bool)arg4 downloadStatus:(int)arg5 forLocalIdentifier:(id)arg6;	// IMP=0x001000000006e9a3
- (id)resourceForLocalIdentifier:(id)arg1;	// IMP=0x001000000006e806
- (id)initWithPhotoLibrary:(id)arg1 clusterer:(id)arg2 andContext:(id)arg3;	// IMP=0x001000000006e54d
