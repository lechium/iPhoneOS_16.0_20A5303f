...
- (void).cxx_destruct;	// IMP=0x0020000000002f0c
- (int)run:(int)arg1 argv:(const char **)arg2;	// IMP=0x0010000000002cca
- (void)registerClient:(id)arg1 forPhotoLibraryURL:(id)arg2 withReply:(CDUnknownBlockType)arg3;	// IMP=0x001000000000297d
- (void)storeAnalysis:(id)arg1 forAsset:(id)arg2 fromPhotoLibraryURL:(id)arg3 withReply:(CDUnknownBlockType)arg4;	// IMP=0x00100000000024a6
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000001f4f
- (void)parseCommandLine:(int)arg1 argv:(const char **)arg2;	// IMP=0x0010000000001d88
- (void)printUsageAndExitWith:(int)arg1 andMessage:(id)arg2;	// IMP=0x0010000000001d20
- (id)init;	// IMP=0x0010000000001ba0
