...
@class NSArray, NSData, NSError, NSString, NSUUID, OTAccountSettingsX, OTControlArguments, OTCustodianRecoveryKey, OTInheritanceKey, OTJoiningConfiguration, OTOperationConfiguration, OTSecureElementPeerIdentity;
