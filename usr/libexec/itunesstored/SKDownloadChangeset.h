...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0020000000012b20
- (void).cxx_destruct;	// IMP=0x0020000000013053
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000012e87
- (id)copyXPCEncoding;	// IMP=0x0010000000012dca
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0010000000012bbe
