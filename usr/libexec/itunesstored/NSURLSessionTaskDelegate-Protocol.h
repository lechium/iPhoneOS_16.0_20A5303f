...
@class MISSING_TYPE, NSError, NSURLAuthenticationChallenge, NSURLRequest, NSURLSession, NSURLSessionTask, NSURLSessionTaskMetrics;
...
- (MISSING_TYPE *)URLSession:task:willPerformHTTPRedirection:newRequest:completionHandler: /* Error: Ran out of types for this method. */;
