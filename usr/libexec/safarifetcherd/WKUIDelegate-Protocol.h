...
@class MISSING_TYPE, NSArray, NSString, UIViewController, WKContextMenuElementInfo, WKFrameInfo, WKNavigationAction, WKPreviewElementInfo, WKSecurityOrigin, WKWebView, WKWebViewConfiguration, WKWindowFeatures;
...
- (MISSING_TYPE *)webView:shouldPreviewElement: /* Error: Ran out of types for this method. */;
