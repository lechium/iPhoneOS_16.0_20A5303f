...
@class MISSING_TYPE, NSError, NSURLAuthenticationChallenge, WKDownload, WKNavigation, WKNavigationAction, WKNavigationResponse, WKWebView, WKWebpagePreferences;
...
- (MISSING_TYPE *)webView:decidePolicyForNavigationResponse:decisionHandler: /* Error: Ran out of types for this method. */;
