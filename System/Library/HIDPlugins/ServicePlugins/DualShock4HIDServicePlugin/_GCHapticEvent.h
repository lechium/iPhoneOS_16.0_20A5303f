...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001b3a
...
- (id)description;	// IMP=0x0000000000001a00
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001811
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x000000000000177e
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001594
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001c74
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001b42
