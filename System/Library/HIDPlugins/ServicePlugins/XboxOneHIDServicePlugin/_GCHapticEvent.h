...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001f76
...
- (id)description;	// IMP=0x0000000000001e3c
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001c4d
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001bba
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x00000000000019d0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000020b0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001f7e
