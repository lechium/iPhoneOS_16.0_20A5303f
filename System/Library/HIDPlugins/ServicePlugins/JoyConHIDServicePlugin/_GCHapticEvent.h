...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000005ec2
...
- (id)description;	// IMP=0x0000000000005d88
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000005b99
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000005b06
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x000000000000591c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000005ffc
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000005eca
