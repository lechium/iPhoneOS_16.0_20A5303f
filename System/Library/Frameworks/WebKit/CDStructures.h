...
struct unique_ptr<WTF::BinarySemaphore, std::default_delete<WTF::BinarySemaphore>> {
    struct __compressed_pair<WTF::BinarySemaphore *, std::default_delete<WTF::BinarySemaphore>> {
        struct BinarySemaphore *__value_;
    } __ptr_;
};
