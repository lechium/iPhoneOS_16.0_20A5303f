...
- (void).cxx_destruct;	// IMP=0x00000000000391d1
@property(retain, nonatomic) VSSubscriptionPredicateFactory *predicateFactory; // @synthesize predicateFactory=_predicateFactory;
- (id)standardizedFetchOptionsFromOptions:(id)arg1 withSecurityTask:(id)arg2;	// IMP=0x0000000000038158
- (id)subscriptionFetchOptionsAllowedForSecurityTask:(id)arg1;	// IMP=0x00000000000379f9
