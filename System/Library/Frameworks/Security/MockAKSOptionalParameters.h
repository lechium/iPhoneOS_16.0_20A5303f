...
- (void).cxx_destruct;	// IMP=0x00000000000513ea
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000512f8
- (unsigned long long)hash;	// IMP=0x000000000005128b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000051193
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000510cf
- (void)copyTo:(id)arg1;	// IMP=0x000000000005104c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000050fd2
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000050e66
- (id)dictionaryRepresentation;	// IMP=0x0000000000050dbc
- (id)description;	// IMP=0x0000000000050d0d
