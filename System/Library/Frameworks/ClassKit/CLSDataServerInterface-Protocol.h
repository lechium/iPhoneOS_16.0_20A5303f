...
@class CLSAdminRequestor, CLSObject, CLSQuerySpecification, CLSSearchSpecification, CLSSurvey, NSArray, NSData, NSDate, NSDictionary, NSFileHandle, NSObject, NSPredicate, NSString, NSURL;
