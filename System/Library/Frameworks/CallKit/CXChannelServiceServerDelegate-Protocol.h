...
- (void)serviceServer:(CXChannelServiceServer *)arg1 client:(CXServiceClient *)arg2 reportedIncomingTransmissionStartedForChannelWithUUID:(NSUUID *)arg3 update:(CXChannelUpdate *)arg4 completionHandler:(void (^)(NSError *))arg5;
