...
- (void)serviceClient:(CXServiceClient *)arg1 reportedIncomingTransmissionStartedForChannelWithUUID:(NSUUID *)arg2 update:(CXChannelUpdate *)arg3 completionHandler:(void (^)(NSError *))arg4;
