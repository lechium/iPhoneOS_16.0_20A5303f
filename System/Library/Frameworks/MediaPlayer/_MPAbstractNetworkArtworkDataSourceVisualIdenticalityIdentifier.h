...
- (void).cxx_destruct;	// IMP=0x00000000001164b5
...
- (id)stringRepresentation;	// IMP=0x00000000001163be
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000011636b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001162be
