...
+ (id)ruleIdentifier;	// IMP=0x001000000012db54
- (void).cxx_destruct;	// IMP=0x000000000012dca9
@property(retain, nonatomic) NSString *modelNumberPrefix; // @synthesize modelNumberPrefix=_modelNumberPrefix;
- (_Bool)evaluate;	// IMP=0x000000000012dbba
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000012db61
