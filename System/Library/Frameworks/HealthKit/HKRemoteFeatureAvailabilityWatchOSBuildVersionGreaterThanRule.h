...
+ (id)ruleIdentifier;	// IMP=0x0010000000110c60
- (void).cxx_destruct;	// IMP=0x0000000000110e05
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x0000000000110cc6
- (void)processUserInfo:(id)arg1;	// IMP=0x0000000000110c6d
