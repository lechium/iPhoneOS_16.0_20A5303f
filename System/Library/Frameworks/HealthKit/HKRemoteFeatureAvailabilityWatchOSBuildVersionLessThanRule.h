...
+ (id)ruleIdentifier;	// IMP=0x0010000000164889
- (void).cxx_destruct;	// IMP=0x0000000000164a2e
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x00000000001648ef
- (void)processUserInfo:(id)arg1;	// IMP=0x0000000000164896
