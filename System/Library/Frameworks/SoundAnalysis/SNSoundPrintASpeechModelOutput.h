...
- (void).cxx_destruct;	// IMP=0x0000000000092e92
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000092d08
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput_1:(id)arg1 Confidence:(id)arg2 Detected:(id)arg3 detectedHistoryOut:(id)arg4;	// IMP=0x0000000000092c06
