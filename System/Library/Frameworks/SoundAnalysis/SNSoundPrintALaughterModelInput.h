...
- (void).cxx_destruct;	// IMP=0x0000000000094913
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000094769
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000094692
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000009467b
