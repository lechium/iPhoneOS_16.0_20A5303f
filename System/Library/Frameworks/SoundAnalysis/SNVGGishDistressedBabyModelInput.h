...
- (void).cxx_destruct;	// IMP=0x0000000000087967
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000877bd
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x00000000000876e6
- (id)initWithInput1:(id)arg1;	// IMP=0x00000000000876cf
