...
- (void).cxx_destruct;	// IMP=0x0000000000094bd2
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000094a48
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput_1:(id)arg1 Confidence:(id)arg2 Detected:(id)arg3 detectedHistoryOut:(id)arg4;	// IMP=0x0000000000094946
