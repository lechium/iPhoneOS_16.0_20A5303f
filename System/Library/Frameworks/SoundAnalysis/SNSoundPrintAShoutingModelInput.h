...
- (void).cxx_destruct;	// IMP=0x0000000000090e93
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000090ce9
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000090c12
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000090bfb
