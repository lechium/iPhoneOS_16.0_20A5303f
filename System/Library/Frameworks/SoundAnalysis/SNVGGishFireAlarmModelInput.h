...
- (void).cxx_destruct;	// IMP=0x000000000008ae91
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008ace7
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000008ac10
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000008abf9
