...
+ (id)markerStyleForTraitCollection:(id)arg1 state:(long long)arg2 styleAttributes:(id)arg3 coordinate:(struct CLLocationCoordinate2D)arg4;	// IMP=0x0060000000037146
- (void).cxx_destruct;	// IMP=0x00000000000379ee
