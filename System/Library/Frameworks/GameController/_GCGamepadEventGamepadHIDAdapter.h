...
- (void).cxx_destruct;	// IMP=0x0000000000072999
...
- (id)observeGamepadEvents:(CDUnknownBlockType)arg1;	// IMP=0x00000000000725c5
- (void)dealloc;	// IMP=0x000000000007256c
- (id)init;	// IMP=0x0000000000072541
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x000000000007226b
