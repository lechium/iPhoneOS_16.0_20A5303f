...
- (void).cxx_destruct;	// IMP=0x000000000007757a
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000076bd2
- (_Bool)hasGPUSupport;	// IMP=0x0000000000076bca
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000076989
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x0000000000076668
