...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000002da55
- (_Bool)hasGPUSupport;	// IMP=0x000000000002da4d
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000002d7e0
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000002d7ca
