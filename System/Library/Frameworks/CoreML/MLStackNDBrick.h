...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000002a6d8
- (_Bool)hasGPUSupport;	// IMP=0x000000000002a6d0
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000002a463
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000002a0bd
