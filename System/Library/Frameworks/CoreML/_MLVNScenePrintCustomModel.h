...
- (void).cxx_destruct;	// IMP=0x00000000000b949d
...
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000b8edf
- (id)featureValueFromScenePrint:(id)arg1 elementSize:(unsigned long long)arg2;	// IMP=0x00000000000b8b21
- (id)initWithModelDescription:(id)arg1 parameterDictionary:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000b8382
