...
+ (id)na_identity;	// IMP=0x006000000002f3a5
- (void).cxx_destruct;	// IMP=0x000000000002f609
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f32f
- (unsigned long long)hash;	// IMP=0x000000000002f2d4
- (id)initWithVisibilityStyle:(unsigned long long)arg1 connectivityState:(unsigned long long)arg2;	// IMP=0x000000000002f188
