...
+ (void)generateReportForSharedFolder:(id)arg1 qualityOfService:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0060000000045fc5
+ (void)_finishReport:(id)arg1 session:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0060000000045b5a
- (void).cxx_destruct;	// IMP=0x00000000000461cf
...
- (id)telemetryEvent;	// IMP=0x00000000000460c1
- (void)incrementErrorRetryCountWithSession:(id)arg1;	// IMP=0x00000000000458f4
- (void)shareChangedDuringCheckWithSession:(id)arg1;	// IMP=0x0000000000045817
- (id)initWithURL:(id)arg1;	// IMP=0x00000000000457ac
