...
- (void).cxx_destruct;	// IMP=0x00000000000d2768
...
- (void)dealloc;	// IMP=0x00000000000d26a2
- (id)initWithDocument:(id)arg1 stageID:(id)arg2 transferSize:(unsigned long long)arg3;	// IMP=0x00000000000d2513
- (id)description;	// IMP=0x00000000000d24e6
