...
- (void).cxx_destruct;	// IMP=0x000000000004574d
...
- (void)syncErrors:(CDUnknownBlockType)arg1;	// IMP=0x000000000004320b
- (void)generateReportWithSession:(id)arg1;	// IMP=0x0000000000040fde
- (id)_injectionForAnalyticsServiceCode:(int)arg1;	// IMP=0x0000000000040f0e
- (void)_fillTransferFailure:(id)arg1 withRowID:(unsigned long long)arg2 atDate:(id)arg3 session:(id)arg4;	// IMP=0x0000000000040c2d
- (id)getRampNumberForSession:(id)arg1;	// IMP=0x0000000000040beb
- (id)init;	// IMP=0x0000000000040b31
