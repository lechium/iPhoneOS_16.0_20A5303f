...
- (void).cxx_destruct;	// IMP=0x000000000014e276
...
- (void)copyProgressInfoToProgress:(id)arg1 options:(BOOL)arg2;	// IMP=0x000000000014e151
- (void)updateLocalizedDescriptionWithOptions:(BOOL)arg1;	// IMP=0x000000000014de91
- (id)init;	// IMP=0x000000000014dde2
