...
- (void).cxx_destruct;	// IMP=0x000000000014d746
...
- (void)verifyFutureProgressIsNotFinished;	// IMP=0x000000000014d655
- (void)copyProgressInfoToProgress:(id)arg1 options:(BOOL)arg2;	// IMP=0x000000000014d577
- (void)updateLocalizedDescriptionWithOptions:(BOOL)arg1;	// IMP=0x00000000002b0cd1
- (void)updateUnitCount;	// IMP=0x000000000014d175
- (id)description;	// IMP=0x000000000014ce2b
- (id)init;	// IMP=0x000000000014cd10
