...
- (void).cxx_destruct;	// IMP=0x000000000003fc46
...
- (id)associatedAppTelemetryEvent;	// IMP=0x000000000003fb21
- (id)subDescription;	// IMP=0x000000000003fa69
- (id)additionalPayload;	// IMP=0x000000000003f927
