...
- (void).cxx_destruct;	// IMP=0x000000000018e3b1
@property(nonatomic) unsigned long long rank; // @synthesize rank=_rank;
- (void)listItems:(CDUnknownBlockType)arg1;	// IMP=0x000000000018e30e
- (id)description;	// IMP=0x000000000018e28f
- (unsigned long long)batchCount;	// IMP=0x000000000018e1f3
- (void)addDeletionOfFileObjectID:(id)arg1 rank:(unsigned long long)arg2;	// IMP=0x000000000018e1b2
- (void)addIndexOfItem:(id)arg1;	// IMP=0x000000000018df35
- (id)init;	// IMP=0x000000000018de98
