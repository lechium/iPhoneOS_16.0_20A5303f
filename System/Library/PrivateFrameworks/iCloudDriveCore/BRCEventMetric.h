...
- (void).cxx_destruct;	// IMP=0x000000000003f8e9
...
- (void)associateWithCompletedOperation:(id)arg1;	// IMP=0x000000000003f7cf
- (id)associatedAppTelemetryEvent;	// IMP=0x000000000003f7c7
- (id)additionalPayload;	// IMP=0x000000000003f7ba
- (id)subDescription;	// IMP=0x000000000003f7ad
- (double)duration;	// IMP=0x000000000003f72a
- (id)description;	// IMP=0x000000000003f696
- (id)initWithEventName:(id)arg1;	// IMP=0x000000000003f627
