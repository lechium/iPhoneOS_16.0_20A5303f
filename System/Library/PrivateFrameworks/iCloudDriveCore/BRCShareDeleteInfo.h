...
- (void).cxx_destruct;	// IMP=0x00000000001fb4d4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001fb432
- (unsigned long long)hash;	// IMP=0x00000000001fb41c
- (id)initWithShareID:(id)arg1 emptyRecord:(id)arg2;	// IMP=0x00000000001fb383
