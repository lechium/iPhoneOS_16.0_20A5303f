...
- (id)description;	// IMP=0x00000000000055cd
@property(readonly, nonatomic) NSString *fsTypeName;
@property(readonly, nonatomic) NSString *mountPath;
- (_Bool)setUpForRelPath:(id)arg1 session:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000052cc
- (int)_setUpForStatfs:(struct statfs)arg1;	// IMP=0x00000000000051c6
