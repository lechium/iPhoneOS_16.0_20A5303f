...
- (void).cxx_destruct;	// IMP=0x00000000001acfc3
...
- (void)chainPreparedRecordBatch:(id)arg1;	// IMP=0x00000000001ac687
- (void)_chainPreppedRecordToParent:(id)arg1;	// IMP=0x00000000001ac3ba
- (void)addFullyChainedRecordInfo:(id)arg1;	// IMP=0x00000000001ab856
- (void)prepareFirstPhaseRecordBatch;	// IMP=0x00000000001ab6af
- (_Bool)containsRecordInfo:(id)arg1;	// IMP=0x00000000001ab54b
- (id)initWithAppLibrary:(id)arg1;	// IMP=0x00000000001ab3ef
