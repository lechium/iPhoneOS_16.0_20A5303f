...
- (void).cxx_destruct;	// IMP=0x0000000000081571
...
- (void)_freeBuffers;	// IMP=0x00000000000814bd
- (void)_compute;	// IMP=0x00000000000808aa
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x000000000008080c
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x00000000000807d1
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x0000000000080796
- (void)dealloc;	// IMP=0x0000000000080758
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x00000000000806e4
