...
+ (id)keyPathsForValuesAffectingExpirationDate;	// IMP=0x0080000000113f4c
+ (id)keyPathsForValuesAffectingLocalPlaybackURL;	// IMP=0x0080000000113f2c
+ (id)fetchRequest;	// IMP=0x0080000000117ad9
