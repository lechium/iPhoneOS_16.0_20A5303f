...
- (void)_collectionView:(UICollectionView *)arg1 performPrimaryActionForItemAtIndexPath:(NSIndexPath *)arg2;
- (_Bool)_collectionView:(UICollectionView *)arg1 canPerformPrimaryActionForItemAtIndexPath:(NSIndexPath *)arg2;
