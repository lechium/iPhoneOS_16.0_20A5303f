...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x006000000009bde5
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x006000000009bb79
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x006000000009bb3f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009ab1e
- (id)init;	// IMP=0x000000000009aa90
