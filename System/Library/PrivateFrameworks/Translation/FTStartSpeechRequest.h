...
- (void).cxx_destruct;	// IMP=0x00000000000ba2a6
- (id)flatbuffData;	// IMP=0x00000000000ba12e
- (Offset_b7f57b05)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000b96d3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b8d56
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartSpeechRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000b8ba2
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartSpeechRequest *)arg2;	// IMP=0x00000000000b8b8c
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000b8b71
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000b8b59
