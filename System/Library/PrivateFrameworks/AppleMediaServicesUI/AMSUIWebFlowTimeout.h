...
+ (id)timeoutWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x006000000008af80
- (void).cxx_destruct;	// IMP=0x000000000008b7bb
...
- (void)reset;	// IMP=0x000000000008b5f7
- (void)pause;	// IMP=0x000000000008b3bb
- (void)start;	// IMP=0x000000000008b008
- (id)initWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000008aec9
