...
- (void)queryAWDLSidecarStatisticsWithCompletionHandler:(void (^)(NSDictionary *))arg1;
- (void)queryAWDLAirPlayStatisticsWithCompletionHandler:(void (^)(NSDictionary *))arg1;
