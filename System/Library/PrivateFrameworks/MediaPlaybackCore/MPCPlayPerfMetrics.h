...
+ (id)playMetricsWithErrorSignature:(id)arg1 event:(id)arg2 cursor:(id)arg3;	// IMP=0x00600000001bb3ba
+ (id)playMetricsWithFirstFrameEvent:(id)arg1 cursor:(id)arg2;	// IMP=0x00600000001b8d05
- (void).cxx_destruct;	// IMP=0x00000000001b8c14
@property(retain, nonatomic) NSMutableDictionary *data; // @synthesize data=_data;
- (void)addEnvironmentInfoWithCursor:(id)arg1;	// IMP=0x00000000001b8b4d
- (void)addAssetLoadInfoWithCursor:(id)arg1 itemIDPayload:(id)arg2;	// IMP=0x00000000001b7e0d
- (void)addSharePlayWithCursor:(id)arg1;	// IMP=0x00000000001b7d83
- (void)addPlaybackBehaviorWithCursor:(id)arg1;	// IMP=0x00000000001b7b99
- (void)addQueueMetadata:(id)arg1;	// IMP=0x00000000001b7aeb
- (id)humanDescription;	// IMP=0x00000000001b6d9b
- (id)description;	// IMP=0x00000000001b6b8d
...
- (id)init;	// IMP=0x00000000001b6121
