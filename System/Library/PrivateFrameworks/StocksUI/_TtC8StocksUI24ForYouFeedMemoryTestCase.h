...
- (void).cxx_destruct;	// IMP=0x00000000000d4d90
- (id)init;	// IMP=0x00000000000d4cd0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000d4c40
