...
- (void).cxx_destruct;	// IMP=0x00000000000e9eb0
@property __weak id <AVOutputDeviceImplSupport> implEventListener; // @synthesize implEventListener=_implSupportEventListener;
- (_Bool)supportsFitnessDataDestination;	// IMP=0x00000000000e9e89
- (void)configureUsingBlock:(CDUnknownBlockType)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e9e4c
- (_Bool)setCurrentBluetoothListeningMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000e9e26
...
- (_Bool)setHeadTrackedSpatialAudioMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000e9de3
@property(readonly, nonatomic) NSString *headTrackedSpatialAudioMode;
- (_Bool)setAllowsHeadTrackedSpatialAudio:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00000000000e9db0
...
- (void)decreaseVolumeByCount:(long long)arg1;	// IMP=0x00000000000e9d1a
- (void)increaseVolumeByCount:(long long)arg1;	// IMP=0x00000000000e9d14
- (void)setVolume:(float)arg1;	// IMP=0x00000000000e9d0e
@property(readonly) long long volumeControlType;
@property(readonly) _Bool canSetVolume;
@property(readonly) float volume;
- (void)setSecondDisplayMode:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e9cc0
- (void)setSecondDisplayEnabled:(_Bool)arg1;	// IMP=0x00000000000e9cba
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e9b71
