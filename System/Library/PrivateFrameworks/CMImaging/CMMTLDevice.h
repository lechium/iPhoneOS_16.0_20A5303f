...
- (void).cxx_destruct;	// IMP=0x0000000000008248
@property(retain, nonatomic) InterceptConfig *interceptConfig; // @synthesize interceptConfig=_interceptConfig;
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000000819c
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000000814c
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000008117
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x00000000000080bf
- (id)newCommandQueueWithMaxCommandBufferCount:(unsigned long long)arg1;	// IMP=0x000000000000808c
- (id)newCommandQueue;	// IMP=0x000000000000805e
@property(retain, nonatomic) FigMetalExecutionStatus *executionStatus;
- (id)initWithLevel:(int)arg1;	// IMP=0x0000000000007f5d
