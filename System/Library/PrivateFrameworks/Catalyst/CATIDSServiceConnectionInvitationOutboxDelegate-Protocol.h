...
- (void)connectionInvitationOutbox:(CATIDSServiceConnectionInvitationOutbox *)arg1 foundConnection:(NSUUID *)arg2 destinationAppleID:(NSString *)arg3 destinationAddress:(NSString *)arg4 networkPowerAssertion:(id <CATCancelable>)arg5 messagingVersion:(unsigned long long)arg6 userInfo:(NSDictionary *)arg7;
