...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000042011
- (void).cxx_destruct;	// IMP=0x0000000000042087
...
- (id)initWithConnectionIdentifier:(id)arg1;	// IMP=0x0000000000041ed4
