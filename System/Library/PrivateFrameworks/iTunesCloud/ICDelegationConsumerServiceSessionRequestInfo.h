...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009d74e
- (unsigned long long)hash;	// IMP=0x000000000009d740
- (id)initWithAccountID:(unsigned long long)arg1 fairPlaySessionID:(unsigned long long)arg2;	// IMP=0x000000000009d6f8
