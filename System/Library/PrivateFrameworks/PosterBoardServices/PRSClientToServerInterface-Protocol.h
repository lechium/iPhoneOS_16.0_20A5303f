...
@class ATXFaceGalleryConfiguration, NSNumber, NSString, NSURL, NSUUID, PRSPosterConfiguration, PRSPosterSnapshotRequest, PRSPosterUpdateSessionInfo, PRSServerPosterPath;
...
- (oneway void)fetchLimitedOcclusionBoundsForPosterConfiguration:(PRSPosterConfiguration *)arg1 orientation:(NSNumber *)arg2 completion:(void (^)(NSArray *, NSError *))arg3;
...
- (oneway void)fetchContentObstructionBoundsForPosterConfiguration:(PRSPosterConfiguration *)arg1 orientation:(NSNumber *)arg2 completion:(void (^)(NSArray *, NSError *))arg3;
...
- (oneway void)importPosterConfigurationFromArchiveAtURL:(NSURL *)arg1 completion:(void (^)(NSUUID *, NSError *))arg2;
- (oneway void)exportPosterConfigurationMatchingUUID:(NSUUID *)arg1 completion:(void (^)(NSURL *, NSError *))arg2;
