...
- (void).cxx_destruct;	// IMP=0x000000000002f2b4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002ef2f
...
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002d64a
- (id)initWithModel:(id)arg1;	// IMP=0x000000000002d5cb
- (id)initWithContentsOfURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002be80
