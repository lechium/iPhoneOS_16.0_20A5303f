...
@class CLHeading, GEOComposedRoute, GEODirectionsRequest, GEODirectionsResponse, MNLocation, MNTracePlayer, NSArray, NSDate, NSError, VGVehicle;
...
@optional
- (void)tracePlayer:(MNTracePlayer *)arg1 didUpdateCurrentRoute:(GEOComposedRoute *)arg2;
