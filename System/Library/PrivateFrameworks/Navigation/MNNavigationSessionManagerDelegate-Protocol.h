...
- (void)navigationSessionManager:(MNNavigationSessionManager *)arg1 willStartNavigationWithRoute:(MNActiveRouteInfo *)arg2 navigationType:(long long)arg3 request:(GEODirectionsRequest *)arg4 response:(GEODirectionsResponse *)arg5 simulationType:(long long)arg6;
@end
