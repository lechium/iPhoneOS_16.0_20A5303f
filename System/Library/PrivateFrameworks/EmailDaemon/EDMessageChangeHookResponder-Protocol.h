...
- (void)persistenceDidUpdateDisplayDateForMessages:(NSArray *)arg1 generation:(long long)arg2;
...
- (void)persistenceDidChangeReadLaterDate:(NSDate *)arg1 messages:(NSArray *)arg2 generationWindow:(EDPersistenceDatabaseGenerationWindow *)arg3;
