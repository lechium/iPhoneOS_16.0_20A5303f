...
@class NSArray, NSOrderedSet, NSSet, NSString, SBAppLayout, SBFFluidBehaviorSettings, SBSwitcherDropRegionContext, SBSwitcherResizeGrabberLayoutAttributes, SBSwitcherShelf;
...
- (_Bool)shouldOnlyDisplayAppNameForTitleAtIndex:(unsigned long long)arg1;
...
- (struct CGSize)maxGridSizeForLayoutRole:(long long)arg1 inAppLayout:(SBAppLayout *)arg2 withBounds:(struct CGRect)arg3;
