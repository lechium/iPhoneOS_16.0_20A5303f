...
@interface NWConcrete_nw_parameters : NSObject
{
    ...
    NSObject<OS_nw_endpoint> *url_endpoint;	// 192 = 0xc0
    NSObject<OS_xpc_object> *metadata;	// 200 = 0xc8
}

- (void).cxx_destruct;	// IMP=0x0000000000232920
- (id)redactedDescription;	// IMP=0x0000000000232900
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000232850
