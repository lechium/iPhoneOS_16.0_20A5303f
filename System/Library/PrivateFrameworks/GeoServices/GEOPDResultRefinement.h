...
- (void).cxx_destruct;	// IMP=0x0000000000e43634
- (unsigned long long)hash;	// IMP=0x0000000000e42d14
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e42b62
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e428ee
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e42463
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e42454
- (id)jsonRepresentation;	// IMP=0x0000000000e3d0df
- (id)dictionaryRepresentation;	// IMP=0x0000000000e3cbba
- (id)description;	// IMP=0x0000000000e3cb0b
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e3bb56
- (id)init;	// IMP=0x0000000000e3bafa
