...
- (void).cxx_destruct;	// IMP=0x000000000089700d
...
- (id)_placecardLayoutConfiguration;	// IMP=0x0000000000896fe5
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x0000000000896fdd
...
- (id)_businessClaim;	// IMP=0x0000000000896f95
- (_Bool)_hasBusinessClaim;	// IMP=0x0000000000896f8d
- (id)_mapItemByStrippingOptionalData;	// IMP=0x0000000000896f84
@property(readonly, nonatomic, getter=_photos) NSArray *photos;
@property(readonly, nonatomic, getter=_reviews) NSArray *reviews;
- (id)_asPlaceInfo;	// IMP=0x0000000000896f2c
...
- (id)_yelpID;	// IMP=0x0000000000896cd2
...
- (id)_urlForWritingAReview;	// IMP=0x0000000000896cba
- (id)_urlForReview:(id)arg1;	// IMP=0x0000000000896cb2
- (id)_urlForPhotoWithUID:(id)arg1;	// IMP=0x0000000000896caa
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000896c27
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000896c1f
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x0000000000896882
- (unsigned int)_travelDistanceForTransportType:(int)arg1;	// IMP=0x0000000000896840
- (unsigned int)_travelTimeForTransportType:(int)arg1;	// IMP=0x00000000008967fe
- (_Bool)_hasTravelTimeForTransportType:(int)arg1;	// IMP=0x00000000008967e1
- (int)_recommendedTransportType;	// IMP=0x00000000008967d6
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x00000000008967b9
...
- (id)weatherDisplayName;	// IMP=0x0000000000896711
- (id)addressObject;	// IMP=0x000000000089665e
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x000000000089607f
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) int referenceFrame;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x0000000000895fc2
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithPlace:(id)arg1;	// IMP=0x0000000000895dde
- (id)initWithPlaceResult:(id)arg1;	// IMP=0x0000000000895d05
