...
- (void).cxx_destruct;	// IMP=0x0000000000ba95a0
- (id)init;	// IMP=0x0000000000ba94a0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000ba9410
