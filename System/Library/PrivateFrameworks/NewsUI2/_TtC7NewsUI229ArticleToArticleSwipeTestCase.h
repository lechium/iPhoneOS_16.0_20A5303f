...
- (void).cxx_destruct;	// IMP=0x0000000000c3bc10
- (id)init;	// IMP=0x0000000000c3bb10
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000c3ba80
