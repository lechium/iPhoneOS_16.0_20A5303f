...
@class BRCMigrationReport, BRFileObjectID, BRGetPausedFileListUpdater, BRMangledID, CKShareMetadata, NSArray, NSData, NSDate, NSDictionary, NSError, NSFileHandle, NSObject, NSSet, NSString, NSURL, NSUUID;
