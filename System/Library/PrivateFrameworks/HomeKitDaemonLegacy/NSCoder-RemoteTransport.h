...
- (id)hm_decodeSetOfConditionalObjects:(Class)arg1 forKey:(id)arg2;	// IMP=0x003000000060aae5
- (void)hm_encodeSetOfConditionalObjects:(id)arg1 forKey:(id)arg2;	// IMP=0x003000000060a859
- (id)hm_decodeArrayOfConditionalObjects:(Class)arg1 forKey:(id)arg2;	// IMP=0x003000000060a702
- (void)hm_encodeArrayOfConditionalObjects:(id)arg1 forKey:(id)arg2;	// IMP=0x003000000060a476
