...
- (void)removeParticipants:(NSArray *)arg1 fromSharedScopeWithIdentifier:(NSString *)arg2 retentionPolicy:(long long)arg3 completionHandler:(void (^)(CPLLibraryShareScopeChange *, NSError *))arg4;
- (void)startExitFromSharedScopeWithIdentifier:(NSString *)arg1 retentionPolicy:(long long)arg2 completionHandler:(void (^)(CPLLibraryShareScopeChange *, NSError *))arg3;
