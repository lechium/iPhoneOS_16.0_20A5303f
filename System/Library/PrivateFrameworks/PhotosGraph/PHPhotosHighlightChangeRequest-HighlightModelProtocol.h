...
- (void)enumerateMomentChangeRequestsForUUIDs:(id)arg1 inPhotoLibrary:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x002000000039cfdd
- (void)clearCurations;	// IMP=0x002000000039cf9d
