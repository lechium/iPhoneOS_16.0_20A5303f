...
- (_Bool)link:(id)arg1 didReceivePacket:(CDStruct_8ac08ad7 *)arg2 fromDeviceUniqueID:(NSString *)arg3 cbuuid:(NSString *)arg4;
...
- (void)link:(id)arg1 didReceiveDataBlobs:(NSArray *)arg2;
