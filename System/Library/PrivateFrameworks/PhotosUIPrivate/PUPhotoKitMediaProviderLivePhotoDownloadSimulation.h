...
- (void).cxx_destruct;	// IMP=0x0000000000360f7d
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x0000000000360d67
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x0000000000360cbe
- (void)_handleResultLivePhoto:(id)arg1 info:(id)arg2;	// IMP=0x0000000000360b42
- (id)init;	// IMP=0x0000000000360a93
