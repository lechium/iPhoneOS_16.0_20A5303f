...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000019949b
- (long long)compare:(id)arg1;	// IMP=0x000000000019945a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001993dd
...
- (unsigned long long)isContentEqualTo:(id)arg1;	// IMP=0x0000000000199325
...
- (void)loadSourceTimeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000019912f
- (id)initWithNormalizedTime:(double)arg1 asset:(id)arg2;	// IMP=0x0000000000199009
- (id)init;	// IMP=0x0000000000198ff2
