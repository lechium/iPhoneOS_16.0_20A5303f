...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x002000000085c984
@property(readonly, nonatomic) NSDictionary *px_debugDictionary;
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x002000000085c816
- (_Bool)px_fetchIsEmpty;	// IMP=0x002000000085c79b
- (id)px_fetchContainedAssetCollections;	// IMP=0x002000000085c6de
- (id)px_fetchAncestryIncludingRoot:(_Bool)arg1;	// IMP=0x002000000085c536
