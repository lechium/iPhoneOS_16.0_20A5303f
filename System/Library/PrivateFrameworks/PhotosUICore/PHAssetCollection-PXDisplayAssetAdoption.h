...
+ (id)px_fetchAssetCollectionsWithAlbumSubtypes:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x00100000008605bf
+ (id)px_fetchSmartAlbumCollectionsBySubtypeForAlbumSubtypes:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x00100000008601af
+ (id)px_contentSyndicationVirtualCollection;	// IMP=0x001000000086017f
+ (id)px_importHistoryAssetCollection;	// IMP=0x001000000086014f
+ (id)px_sharedActivityVirtualCollection;	// IMP=0x001000000086011f
+ (id)px_completeMyMomentVirtualCollection;	// IMP=0x00100000008600ef
+ (id)px_prototypeVirtualCollection;	// IMP=0x00100000008600bf
+ (id)px_searchVirtualCollection;	// IMP=0x001000000086008f
+ (id)px_sharedAlbumsVirtualCollection;	// IMP=0x001000000086005f
+ (id)px_myAlbumsVirtualCollection;	// IMP=0x001000000086002f
+ (id)px_allAlbumsVirtualCollection;	// IMP=0x001000000085ffff
+ (id)px_forYouVirtualCollection;	// IMP=0x001000000085ffcf
+ (id)px_memoriesVirtualCollection;	// IMP=0x001000000085ff9f
+ (id)px_peopleVirtualCollection;	// IMP=0x001000000085ff6f
+ (id)px_photosVirtualCollection;	// IMP=0x001000000085ff3f
+ (id)px_momentsVirtualCollection;	// IMP=0x001000000085ff0f
+ (id)px_fetchSmartAlbumWithSubtype:(long long)arg1;	// IMP=0x001000000085fda5
+ (id)px_smartAlbumWithSubtype:(long long)arg1;	// IMP=0x001000000085fd55
+ (id)px_regularAlbumWithTitle:(id)arg1;	// IMP=0x001000000085fc52
+ (id)px_otherAlbumsSubtypes;	// IMP=0x001000000085fbef
+ (id)px_mediaTypeSmartAlbumSubtypes;	// IMP=0x001000000085fb8c
+ (void)px_getType:(long long *)arg1 subtype:(long long *)arg2 forBuiltInAlbumName:(id)arg3;	// IMP=0x001000000085f7a4
+ (id)px_builtInAlbumNameForSubtype:(long long)arg1;	// IMP=0x001000000085f543
...
- (id)localizedDateDescriptionWithOptions:(unsigned long long)arg1;	// IMP=0x001000000061c36f
...
- (void)px_assignStoryTitleCategoryIfNeeded;	// IMP=0x001000000085de29
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x001000000085dda9
...
- (id)px_debugDictionary;	// IMP=0x001000000085d41c
- (unsigned long long)px_assetsDropMode;	// IMP=0x001000000085d37f
- (_Bool)px_shouldUseFacesRectForSmartCropping;	// IMP=0x001000000085d377
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x001000000085d234
