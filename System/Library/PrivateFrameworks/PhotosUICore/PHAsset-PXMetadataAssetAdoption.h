...
+ (void)px_generateResourceFilesForAssets:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000003b4168
+ (id)addressWithoutUnitedStatesZipCode:(id)arg1;	// IMP=0x00100000003b3ffa
+ (id)px_orderedAssetsFromAssets:(id)arg1 sortDescriptors:(id)arg2;	// IMP=0x00100000003b3da3
+ (id)px_fetchPlacesAssetsInAssetCollection:(id)arg1 options:(id)arg2;	// IMP=0x00100000003b3a79
+ (id)px_fetchAssetsInArray:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x00100000003b39c7
@property(readonly, nonatomic) struct CGPoint positionOffset;
@property(readonly, nonatomic) struct CGAffineTransform transform;
- (float)px_playbackScore;	// IMP=0x00100000001244fc
- (double)weightUsingWeightingScheme:(long long)arg1;	// IMP=0x0010000000124269
- (double)weightUsingCriterion:(long long)arg1;	// IMP=0x0010000000124212
@property(readonly, nonatomic) double weight;
@property(readonly, nonatomic) struct CGSize size;
- (_Bool)px_isRecommendationSeenForVariationType:(long long)arg1;	// IMP=0x00100000002f10b8
- (_Bool)px_isVariationTypeRecommended:(long long)arg1;	// IMP=0x00100000002f0f79
- (id)_userFeedbackScoreInfo;	// IMP=0x00100000003b2e13
- (id)_imageProcessingFlags;	// IMP=0x00100000003b2bb5
@property(readonly, nonatomic) _Bool px_shotWithNightMode;
- (id)_videoDeferredProcessingNeededString:(unsigned short)arg1;	// IMP=0x00100000003b2aea
- (id)_deferredProcessingStringWithEnum:(unsigned short)arg1;	// IMP=0x00100000003b2ac6
- (id)_junkClassificationStringWithClassifications:(id)arg1;	// IMP=0x00100000003b24d3
- (id)_sdClassificationStringWithClassifications:(id)arg1;	// IMP=0x00100000003b2253
- (id)_sceneClassificationStringWithClassifications:(id)arg1;	// IMP=0x00100000003b1cf4
- (id)_ocrStrings;	// IMP=0x00100000003b1ce7
- (id)stringMinutesTimeRangeFromTimeRange:(CDStruct_3c1748cc)arg1;	// IMP=0x00100000003b1bf0
@property(readonly, nonatomic) PXDebugValueList *px_curationDebugValues;
- (id)px_detailedDebugDescriptionInLibrary:(id)arg1;	// IMP=0x00100000003af494
@property(readonly, nonatomic) NSAttributedString *px_curationDebugString;
- (id)px_slHighlightWithError:(id *)arg1;	// IMP=0x00100000003ae93d
...
- (id)px_singleLineMailingAddress;	// IMP=0x00100000003ae48e
...
- (struct CGRect)bestCropRectForAspectRatioV2:(double)arg1 verticalContentMode:(long long)arg2 cropMode:(long long)arg3;	// IMP=0x001000000061ba55
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1 verticalContentMode:(long long)arg2 cropMode:(long long)arg3;	// IMP=0x001000000061b78b
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1;	// IMP=0x001000000061b764
@property(readonly, nonatomic) unsigned long long thumbnailVersion;
- (long long)isContentEqualTo:(id)arg1;	// IMP=0x001000000061b678
@property(readonly, nonatomic) Class defaultImageProviderClass;
- (id)localizedDetailedGeoDescriptionForRTL:(_Bool)arg1;	// IMP=0x001000000061b488
...
- (id)_faceNamesStringForAsset;	// IMP=0x00100000006f6325
- (id)px_accessibilityLabelForStyles:(unsigned long long)arg1;	// IMP=0x00100000006f5e9c
@property(readonly, nonatomic) _Bool requiresConfidentiality;
- (_Bool)px_isSupportedApp:(id)arg1;	// IMP=0x0010000000861ca2
...
- (id)_px_currentRAWResource;	// IMP=0x0010000000874fcd
