...
+ (id)px_otherAlbumsCollectionListIncludeDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3;	// IMP=0x001000000085eed4
+ (id)_otherAlbumAssetCollectionsIncludingRecentlyDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3 includingSharedLibrary:(_Bool)arg4 includingDebugAlbums:(_Bool)arg5;	// IMP=0x001000000085e055
+ (id)_otherAlbumsCollectionListWithDeletedCollection:(_Bool)arg1 withHiddenCollection:(_Bool)arg2 withDuplicatesCollection:(_Bool)arg3;	// IMP=0x001000000085df8d
+ (id)px_mediaTypesCollectionList;	// IMP=0x001000000085df5d
+ (id)px_sharedAlbumsAndActivityCollectionList;	// IMP=0x001000000085df2d
+ (id)px_sharedAlbumsCollectionList;	// IMP=0x001000000085defd
+ (id)px_rootAlbumCollectionList;	// IMP=0x001000000085de96
+ (id)px_rootProjectCollectionList;	// IMP=0x001000000085de2f
...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x001000000085cf11
- (_Bool)px_isContainedInCollectionList:(id)arg1;	// IMP=0x001000000085cde5
...
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x001000000085cbde
