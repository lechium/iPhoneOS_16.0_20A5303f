...
@optional
- (void)requestDebuggingApplicationsInstallation:(NSArray *)arg1 requiredEntitlements:(NSArray *)arg2 completionHandler:(void (^)(_Bool))arg3;
...
- (void)requestESSOApplicationDisclosureWithUsername:(NSString *)arg1 appName:(NSString *)arg2 iTunesItemID:(NSNumber *)arg3 completionHandler:(void (^)(_Bool))arg4;
