...
+ (void)hu_enableAnimations:(_Bool)arg1 forBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000003683aa
- (_Bool)hu_isDescendantOfPickerView;	// IMP=0x00100000003684a6
- (_Bool)hu_isHomeAffordancePresent;	// IMP=0x001000000036842e
- (void)hu_autoSizeByConstrainingWidth:(double)arg1;	// IMP=0x00100000003682cf
- (void)hu_traverseViewHierarchy:(CDUnknownBlockType)arg1;	// IMP=0x001000000036815a
- (void)hu_setFramePreservingTransform:(struct CGRect)arg1;	// IMP=0x00100000003680c4
- (struct CGRect)hu_frameInGlobalCoordinateSpace;	// IMP=0x0010000000488c90
- (struct CGPoint)hu_centerInGlobalCoordinateSpace;	// IMP=0x0010000000488c6c
- (id)pinToEdgesConstraints:(id)arg1;	// IMP=0x001000000054b229
- (void)pinToEdges:(id)arg1;	// IMP=0x001000000054b1d9
