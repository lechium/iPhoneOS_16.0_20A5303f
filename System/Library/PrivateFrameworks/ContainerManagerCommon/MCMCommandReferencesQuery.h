...
+ (Class)incomingMessageClass;	// IMP=0x00100000000681ed
+ (unsigned long long)command;	// IMP=0x00100000000681b7
- (void).cxx_destruct;	// IMP=0x0000000000067f8b
...
- (void)execute;	// IMP=0x0000000000067a48
- (_Bool)preflightClientAllowed;	// IMP=0x00000000000679af
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000067891
