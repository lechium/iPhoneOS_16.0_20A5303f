...
+ (Class)incomingMessageClass;	// IMP=0x0010000000036193
+ (unsigned long long)command;	// IMP=0x001000000003615d
- (void).cxx_destruct;	// IMP=0x00000000000360b4
...
- (void)execute;	// IMP=0x00000000000355d2
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000035539
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000035404
