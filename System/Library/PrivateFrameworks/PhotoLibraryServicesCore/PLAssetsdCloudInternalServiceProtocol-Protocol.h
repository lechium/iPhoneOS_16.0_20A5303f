...
- (void)removeParticipantsWithParticipantUUIDs:(NSArray *)arg1 fromLibraryScopeWithIdentifier:(NSString *)arg2 retentionPolicy:(long long)arg3 reply:(void (^)(NSError *))arg4;
- (void)startExitFromLibraryScopeWithIdentifier:(NSString *)arg1 retentionPolicy:(long long)arg2 reply:(void (^)(NSError *))arg3;
...
- (void)activateLibraryScopeWithUUID:(NSString *)arg1 reply:(void (^)(_Bool, NSError *))arg2;
