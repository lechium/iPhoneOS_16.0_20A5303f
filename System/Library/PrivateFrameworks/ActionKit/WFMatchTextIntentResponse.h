...
+ (id)invalidRegularExpressionIntentResponseWithErrorDescription:(id)arg1;	// IMP=0x00600000003be86d
@property(nonatomic) long long code; // @synthesize code=_code;
- (id)initWithCode:(long long)arg1 userActivity:(id)arg2;	// IMP=0x00000000003be7d1
