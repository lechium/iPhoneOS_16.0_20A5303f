...
- (void).cxx_destruct;	// IMP=0x000000000001e97e
...
- (id)specifiers;	// IMP=0x000000000001e554
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x000000000001e4fe
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x000000000001e46c
