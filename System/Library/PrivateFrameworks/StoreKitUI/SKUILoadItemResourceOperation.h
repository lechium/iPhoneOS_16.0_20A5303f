...
- (void).cxx_destruct;	// IMP=0x0000000000219161
@property __weak SSVPlatformRequestOperation *underlyingOperation; // @synthesize underlyingOperation=_underlyingOperation;
- (void)cancel;	// IMP=0x00000000002190c7
- (void)main;	// IMP=0x0000000000218af1
- (id)initWithResourceRequest:(id)arg1;	// IMP=0x0000000000218ac2
