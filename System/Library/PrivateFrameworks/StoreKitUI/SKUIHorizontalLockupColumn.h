...
- (void).cxx_destruct;	// IMP=0x0000000000247c71
...
- (id)description;	// IMP=0x0000000000247b73
- (void)_addChildViewElement:(id)arg1;	// IMP=0x0000000000247b5d
- (id)init;	// IMP=0x0000000000247b07
