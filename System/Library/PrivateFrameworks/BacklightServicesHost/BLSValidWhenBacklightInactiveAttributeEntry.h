...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x00100000000502c3
- (void).cxx_destruct;	// IMP=0x0000000000050481
...
- (void)invalidate;	// IMP=0x0000000000050439
- (_Bool)reactivateIfPossible;	// IMP=0x0000000000050431
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x000000000005037a
