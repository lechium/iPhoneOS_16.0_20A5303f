...
- (void).cxx_destruct;	// IMP=0x0000000000064dcb
@property __weak AKTextAttributesViewController *parentController; // @synthesize parentController=_parentController;
- (void)syncTextAttributesToUI:(id)arg1;	// IMP=0x0000000000064d32
- (id)convertTextAttributes:(id)arg1;	// IMP=0x0000000000064caf
- (long long)tag;	// IMP=0x0000000000064ca4
