...
- (void).cxx_destruct;	// IMP=0x000000000006c550
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000006c360
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithIn:(id)arg1 lstm_1_h_in:(id)arg2 lstm_1_c_in:(id)arg3;	// IMP=0x000000000006c280
- (id)initWithIn:(id)arg1;	// IMP=0x000000000006c260
