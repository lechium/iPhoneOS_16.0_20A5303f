...
- (void).cxx_destruct;	// IMP=0x0000000000009917
...
- (id)randomCallbackIdentifier;	// IMP=0x00000000000097d5
- (id)createDaemonDisconnectedError;	// IMP=0x00000000000095d1
- (void)handleInterruption;	// IMP=0x00000000000091b2
- (void)unregisterOptionResultCallback:(id)arg1;	// IMP=0x000000000000913a
- (id)registerOptionResultCallback:(CDUnknownBlockType)arg1;	// IMP=0x000000000000907f
- (void)unregisterResultCallback:(id)arg1;	// IMP=0x0000000000009007
- (id)registerResultCallback:(CDUnknownBlockType)arg1;	// IMP=0x0000000000008f4c
- (void)unregisterCallback:(id)arg1;	// IMP=0x0000000000008ed4
- (id)registerCallback:(CDUnknownBlockType)arg1;	// IMP=0x0000000000008e19
- (void)configureHandlersForConnection:(id)arg1;	// IMP=0x0000000000008c73
- (id)initWithName:(id)arg1 errorDomain:(id)arg2 errorCode:(long long)arg3 logger:(id)arg4;	// IMP=0x0000000000008b00
