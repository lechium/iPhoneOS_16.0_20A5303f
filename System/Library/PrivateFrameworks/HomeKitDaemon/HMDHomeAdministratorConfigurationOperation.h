...
+ (id)logCategory;	// IMP=0x00100000007577fc
+ (double)timeout;	// IMP=0x001000000075771e
- (void).cxx_destruct;	// IMP=0x000000000075754a
...
- (id)logIdentifier;	// IMP=0x000000000075741b
- (void)main;	// IMP=0x000000000075731a
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x00000000007571cf
