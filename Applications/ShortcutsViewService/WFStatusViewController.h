...
+ (id)requestIdentifierForContext:(id)arg1;	// IMP=0x002000000000470d
- (void).cxx_destruct;	// IMP=0x0020000000004678
...
- (void)setCompletingSuccessfully:(_Bool)arg1;	// IMP=0x00100000000043b9
- (void)setContentSize:(struct CGSize)arg1;	// IMP=0x00100000000043a7
- (id)labelFont;	// IMP=0x00100000000042e8
- (id)initWithRunningContext:(id)arg1 attribution:(id)arg2 progress:(id)arg3;	// IMP=0x0010000000003fce
- (id)initWithRunningContext:(id)arg1 attribution:(id)arg2;	// IMP=0x0010000000003fb9
