...
@class MISSING_TYPE, MKAnnotationView, MKClusterAnnotation, MKMapView, MKOverlayRenderer, MKOverlayView, MKUserLocation, NSArray, NSError, UIControl;
...
- (MISSING_TYPE *)mapView:didDeselectAnnotationView: /* Error: Ran out of types for this method. */;
