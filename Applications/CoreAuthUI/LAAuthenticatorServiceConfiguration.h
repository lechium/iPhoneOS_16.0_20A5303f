...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000010f0e
- (void).cxx_destruct;	// IMP=0x002000000001284b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000012069
- (id)validateConfiguration;	// IMP=0x0010000000011d09
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001153a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000010f16
- (id)initWithCustomPasswordConfiguration:(id)arg1 context:(id)arg2;	// IMP=0x0010000000010d5f
- (id)initWithContext:(id)arg1 requirement:(unsigned long long)arg2 options:(id)arg3;	// IMP=0x0010000000010cbc
- (id)initWithContext:(id)arg1 requirement:(unsigned long long)arg2;	// IMP=0x0010000000010954
- (id)initWithContext:(id)arg1;	// IMP=0x0010000000010940
