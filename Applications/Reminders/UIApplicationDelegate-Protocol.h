...
@class CKShareMetadata, INIntent, MISSING_TYPE, NSCoder, NSData, NSDictionary, NSError, NSSet, NSString, NSURL, NSUserActivity, UIApplication, UIApplicationShortcutItem, UILocalNotification, UISceneConfiguration, UISceneConnectionOptions, UISceneSession, UIUserNotificationSettings, UIWindow;
...
- (MISSING_TYPE *)application:viewControllerWithRestorationIdentifierPath:coder: /* Error: Ran out of types for this method. */;
