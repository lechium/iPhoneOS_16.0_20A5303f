...
- (void).cxx_destruct;	// IMP=0x00200000000a9b4d
...
- (void)loadInRegistry:(id)arg1;	// IMP=0x00100000000a8b8a
- (id)initWithContext:(id)arg1 privateDataUpdateCoordinator:(id)arg2;	// IMP=0x00100000000a8aac
