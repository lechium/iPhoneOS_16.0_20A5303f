...
+ (struct _NSRange)highlightedLaneRangeForLanes:(id)arg1;	// IMP=0x0040000000a639af
+ (id)_createFakeLanes;	// IMP=0x0010000000a631c2
+ (id)fakeInfoForManeuver:(_Bool)arg1;	// IMP=0x0010000000a6308a
- (void).cxx_destruct;	// IMP=0x0020000000a63cdf
...
- (id)highlightedLanes;	// IMP=0x0010000000a63c79
@property(readonly, nonatomic) struct _NSRange highlightedLaneRange;
@property(readonly, nonatomic) _Bool isForMidStep;
- (id)description;	// IMP=0x0010000000a637f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000a63732
- (id)initWithLaneInfoId:(id)arg1 lanes:(id)arg2 forManeuver:(_Bool)arg3 midStepTitles:(id)arg4 details:(id)arg5;	// IMP=0x0010000000a63624
- (id)initWithLaneInfoId:(id)arg1 lanes:(id)arg2;	// IMP=0x0010000000a635f8
- (id)initWithGuidanceLaneInfo:(id)arg1;	// IMP=0x0010000000a632d6
