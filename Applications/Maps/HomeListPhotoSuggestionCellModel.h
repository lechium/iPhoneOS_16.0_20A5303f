...
- (void).cxx_destruct;	// IMP=0x0020000000a8925e
@property(readonly, nonatomic) MapsSuggestionsEntry *entry; // @synthesize entry=_entry;
- (_Bool)needsReloadFromPreviousViewModel:(id)arg1;	// IMP=0x0010000000a8923f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000a8916c
@property(readonly) unsigned long long hash;
@property(readonly, nonatomic) NSString *subtitle;
@property(readonly, nonatomic) NSString *title;
- (id)initWithEntry:(id)arg1;	// IMP=0x0010000000a8906d
