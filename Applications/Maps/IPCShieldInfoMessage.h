...
+ (id)ipcMessageForShieldInfo:(id)arg1;	// IMP=0x00100000008dafdf
- (void).cxx_destruct;	// IMP=0x0010000000b22cf0
...
- (id)description;	// IMP=0x0010000000b22b76
- (id)dictionaryValue;	// IMP=0x0010000000b229f7
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000b228d4
- (id)shieldInfo;	// IMP=0x00100000008db0ad
