...
+ (id)updatedGuidanceWithPreviousGuidance:(id)arg1 currentGuidance:(id)arg2;	// IMP=0x0040000000100074
- (void).cxx_destruct;	// IMP=0x002000000010124f
...
- (void)_setNeedsChangeNotification;	// IMP=0x0010000000100f6b
- (void)_notifyObserversWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000100e34
- (id)description;	// IMP=0x0010000000100852
- (void)removeGuidanceObserver:(id)arg1;	// IMP=0x001000000010083c
- (void)addGuidanceObserver:(id)arg1;	// IMP=0x0010000000100826
- (_Bool)matchesManeuver:(int)arg1 minorTextAlternatives:(id)arg2;	// IMP=0x001000000010071e
- (_Bool)matchesManeuver:(int)arg1 minorTextAlternatives:(id)arg2 shieldInfo:(id)arg3;	// IMP=0x0010000000100588
@property(retain, nonatomic) MKServerFormattedString *minorText;
@property(retain, nonatomic) MKServerFormattedString *majorText;
- (id)initWithSignID:(id)arg1 maneuverArtwork:(id)arg2 majorTextAlternatives:(id)arg3 minorTextAlternatives:(id)arg4 shieldInfo:(id)arg5;	// IMP=0x00100000001001fa
