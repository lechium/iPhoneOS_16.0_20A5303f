...
- (void).cxx_destruct;	// IMP=0x0020000000256095
...
- (id)description;	// IMP=0x0010000000255f80
- (id)dictionaryValue;	// IMP=0x0010000000255ddc
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000255c62
