...
- (void).cxx_destruct;	// IMP=0x0020000000adbb0c
@property(retain, nonatomic) GEOURLCollectionStorage *collectionStorage; // @synthesize collectionStorage=_collectionStorage;
- (_Bool)isCompatibleWithRestorationTask;	// IMP=0x0010000000adbadf
- (_Bool)isCompatibleWithNavigation;	// IMP=0x0010000000adbad7
- (id)initWithCollectionStorage:(id)arg1;	// IMP=0x0010000000adba69
