...
{
    BNBannerSource *_target;	// 8 = 0x8
    BannerItem *_item;	// 16 = 0x10
    MapsBannerContentView *_contentView;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x0020000000948549
...
- (id)initWithTarget:(id)arg1 item:(id)arg2;	// IMP=0x001000000094812e
