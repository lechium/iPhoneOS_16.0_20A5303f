...
- (void).cxx_destruct;	// IMP=0x00200000002fe6e7
...
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x00100000002fe291
- (_Bool)_isRecursivelyComplete;	// IMP=0x00100000002fe23d
...
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 arrivalPoint:(struct CLLocationCoordinate2D)arg3;	// IMP=0x00100000002fde25
