...
- (void).cxx_destruct;	// IMP=0x00200000002042dc
...
- (id)deltaFromSnapshot:(id)arg1;	// IMP=0x0010000000203dad
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000203c52
- (id)init;	// IMP=0x0010000000203bec
