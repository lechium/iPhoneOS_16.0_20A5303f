...
- (void).cxx_destruct;	// IMP=0x00200000004561f7
...
- (void)_setupResultWithRAPInfos:(id)arg1;	// IMP=0x0010000000455f75
- (id)initWithRAPInfos:(id)arg1;	// IMP=0x0010000000455f0d
