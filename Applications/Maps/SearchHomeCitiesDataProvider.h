...
- (void).cxx_destruct;	// IMP=0x0020000000502fce
...
- (id)headerAccessibilityIdentifier;	// IMP=0x0010000000502f6d
- (id)initWithObjects:(id)arg1 type:(long long)arg2 identifier:(id)arg3 title:(id)arg4;	// IMP=0x0010000000502e1e
