...
- (id)compile;	// IMP=0x0010000000009202
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000008ee0
- (id)initWithDate:(id)arg1 identifier:(id)arg2 itemIdentifier:(id)arg3 localizations:(id)arg4 offerName:(id)arg5 status:(long long)arg6;	// IMP=0x0010000000008dd4
