...
- (void).cxx_destruct;	// IMP=0x002000000000787d
...
- (id)compile;	// IMP=0x0010000000007624
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000007302
- (id)initWithDate:(id)arg1 identifier:(id)arg2 itemIdentifier:(id)arg3 localizations:(id)arg4 offerName:(id)arg5 status:(long long)arg6;	// IMP=0x00100000000071f6
