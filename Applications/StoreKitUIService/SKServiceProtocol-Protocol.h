...
- (void)storefrontForClientType:(long long)arg1 withReplyBlock:(void (^)(NSString *, NSString *))arg2;
...
- (MISSING_TYPE *)checkServerQueueForQueue:withClient: /* Error: Ran out of types for this method. */;
